            ...
            <div className="space-y-3">
              <div>
                ...
                <a
                  ...
                  className="mt-2 flex items-start gap-1.5 text-xs text-red-500 hover:text-red-600 font-medium transition-colors leading-snug group"
                >
                  <svg
                  ...
                  <span className="group-hover:underline">
                    Peur du plagiat ? N'hésitez pas à apposer un watermark (filigrane) sur votre PDF avant de l'importer.
                  </span>
                </a>
