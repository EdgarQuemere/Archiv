...
export function FilterDrawer({
  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-hidden font-sans font-medium flex justify-center sm:justify-end items-center sm:items-start p-3 sm:p-6 pointer-events-none">
      {/* Backdrop Overlay */}
      <div
        ref={backdropRef}
        className="fixed inset-0 z-50 bg-black/20 backdrop-blur-sm transition-opacity pointer-events-auto"
        onClick={handleClose}
      />

      {/* Filter Modal / Card Popover */}
      <div className="relative z-50 w-full sm:w-[562px] max-w-full sm:max-w-[calc(100vw-2rem)] pointer-events-auto my-auto sm:mt-15 md:mt-17 -translate-y-5 self-center sm:self-start">
        <div
          ref={panelRef}
