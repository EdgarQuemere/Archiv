...
export function FilterDrawer({
  ...
  return (
    <div className="fixed inset-0 z-40 overflow-hidden font-sans font-medium flex justify-center sm:justify-end items-center sm:items-start p-3 sm:p-6 pointer-events-none">
      ...
      <div className="relative z-40 w-full sm:w-[562px] max-w-full sm:max-w-[calc(100vw-2rem)] pointer-events-auto my-auto sm:mt-15 md:mt-17 -translate-y-[10px] self-center sm:self-start">
        <div
          ref={panelRef}
